...
export function LandingPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // intentionally stays on until navigation occurs.
          ...
          >
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
